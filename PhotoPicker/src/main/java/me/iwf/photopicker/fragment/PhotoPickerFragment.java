...
public class PhotoPickerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView nbItem = (TextView) rootView.findViewById(R.id.photo_count);
        nbItem.setText(getString(R.string.__picker_done_with_count, 0, getArguments().getInt(EXTRA_COUNT)));
